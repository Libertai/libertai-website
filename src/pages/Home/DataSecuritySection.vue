<template>
	<section class="flex justify-center">
		<div class="flex justify-center gap-x-6 px-24 py-48 max-lg:px-6" style="width: 1440px">
			...
			>
				<img class="max-xl:hidden" alt="No harvesting 1" height="408" src="../../assets/data1.png" width="180" />
