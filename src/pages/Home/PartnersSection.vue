<template>
	<section id="partners" class="relative flex justify-center">
		<div class="h-96 w-[1440px]">
			<div class="flex h-full flex-col items-center justify-center">
				<a href="#partners">
					<h2 class="body-bold-large text-center text-majorelle-800">Proudly supported by</h2>
				</a>
