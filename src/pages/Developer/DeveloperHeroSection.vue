<template>
	<div class="image-background grid overflow-hidden bg-white lg:grid-cols-[40%_60%]">
		<div class="absolute left-0 top-0 z-10 h-full w-full bg-white max-lg:hidden"></div>
		<div
			class="z-10 m-auto flex max-w-xl flex-col items-center justify-center gap-y-6 pl-8 text-center max-lg:gap-y-12 max-lg:px-4 max-lg:py-40 max-lg:text-neutral-100"
		>
		...
		<img alt="Developer" class="m-auto max-lg:hidden" src="../../assets/developer.png" />
	</div>
</template>
