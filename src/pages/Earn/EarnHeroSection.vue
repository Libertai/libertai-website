<template>
	<section class="relative flex justify-center bg-white">
		<div class="image-background relative grid overflow-hidden bg-white lg:grid-cols-[50%_50%]" style="width: 1440px">
			...
			<div
				class="z-20 m-auto flex max-w-xl flex-col items-center justify-center gap-y-6 text-center text-majorelle-800 max-lg:gap-y-12 max-lg:px-4 max-lg:py-40 max-lg:text-neutral-100"
			>
