<template>
	<section class="relative flex w-full justify-center bg-gradient-to-b from-neutral-white to-tertiary">
		<div class="grid py-44 max-lg:pb-0 max-lg:pt-16 lg:grid-cols-[40%_60%] lg:pl-12" style="width: 1440px">
			<div
