...
const countdownEnd = dayjs.unix(1719928800);
	...
	<section class="image-background relative flex min-h-screen justify-center text-center">
		<div class="flex w-full py-20 backdrop-blur-sm max-lg:px-0">
			<div class="m-auto flex max-w-4xl flex-col gap-6 px-6 py-9 text-neutral-white max-lg:py-0 max-lg:text-center">
				<h1 class="max-lg:hidden">LibertAI Unleashed - Token unlock</h1>
				<h2 class="hidden sm:max-lg:block">LibertAI Unleashed - Token unlock</h2>
				<h3 class="hidden font-bold max-sm:block">LibertAI Unleashed - Token unlock</h3>
				<p class="body-small">
					We are pleased to share that on Jul 2, 2024, 14:00 UTC the LTAI token will receive full capabilities.
				</p>
